'use strict';
// Bank of Tanzania exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/botz';
...
/** Latest rate for one pair, e.g. getRate('USD', 'TZS', { apiKey }). */
