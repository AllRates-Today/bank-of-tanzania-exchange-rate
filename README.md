# Bank of Tanzania Exchange Rate API — bank-of-tanzania-exchange-rate
...
Also published under the org scope as [`@allratestoday/bank-of-tanzania-exchange-rate`](https://www.npmjs.com/package/@allratestoday/bank-of-tanzania-exchange-rate) — same code, same versions.
